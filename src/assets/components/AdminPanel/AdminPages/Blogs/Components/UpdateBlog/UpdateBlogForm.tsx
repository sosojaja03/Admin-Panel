...
// import { updateBlogInAdmin } from "../../API";
...
//     updateBlogInAdmin(id as string, values); // Call the API to update the blog
//     message.success("Blog updated successfully");
//     navigate("/dashboard/blogs"); // Navigate back to the blogs list
//   };
